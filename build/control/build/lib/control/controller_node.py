...
class ControllerNode(Node):
    def __init__(self):
        ...
        self.DIST_THRESHOLD = 225         # 前方障礙門檻
        self.RIGHT_THRESHOLD = 320        # 判斷右邊牆不見的門檻
        self.IDEAL_WALL_DISTANCE = 180    # 理想貼牆距離
    ...
    def maze_open_control(self):
        ...
        if self.in_wall_follow_mode:
            if front < self.DIST_THRESHOLD:
                ...
                adjustment = max(min(adjustment, 30), -30)
